...
FROM ingredients;
```
![조회 결과](images_and_resources/15_queries/query_1.png)
...
WHERE user_id = 1;
```
![alt text](images_and_resources/15_queries/query_2.png)
...
![alt text](images_and_resources/15_queries/query_3.png)
...
![alt text](images_and_resources/15_queries/query_4.png)
...
![alt text](images_and_resources/15_queries/query_5.png)
...
![alt text](images_and_resources/15_queries/query_6.png)
...
![alt text](images_and_resources/15_queries/query_7.png)
...
![alt text](images_and_resources/15_queries/query_8.png)
...
GROUP BY u.name;
```
![alt text](images_and_resources/15_queries/query_9.png)
...
GROUP BY status;
```
![alt text](images_and_resources/15_queries/query_10.png)
...
![alt text](images_and_resources/15_queries/query_11.png)
...
```
![alt text](images_and_resources/15_queries/query_12.png)
...
```
![결과](images_and_resources/15_queries/query_13.png)

결과 반영

![반영된_결과_확인](images_and_resources/15_queries/query_13_result.png)
```SQL
-- 14. 상태가 '폐기대상'으로 분류된 식재료 데이터를 테이블에서 영구 삭제한다.
DELETE FROM ingredients
WHERE status = '폐기대상';
```
![결과](images_and_resources/15_queries/query_14.png)

결과 반영
![alt text](images_and_resources/15_queries/query_14_result.png)
...
```
![alt text](images_and_resources/15_queries/query_15.png)

결과 반영

![alt text](images_and_resources/15_queries/query_15_result.png)